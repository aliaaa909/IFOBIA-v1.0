...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("com/ifobia/icon/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("com/ifobia/icon/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("/com/ifobia/icon/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("/com/ifobia/icon/light.svg"));
        }
    }
