...
private final String menuItemsUser[][] = {
   ...
   // {"Kelola Jadwal"},
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("/com/ifobia/icon/white.png")));
   ...
   private void createMenu() {
    int index = 0;
    String[][] menuItems = FormMenuUtama.isAdmin() ? menuItemsAdmin : menuItemsUser;
